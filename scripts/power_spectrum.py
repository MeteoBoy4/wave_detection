...
def main(args=sys.argv[1:]):
    ...
    folder_name = args.output + '_lat{0}-{1}_lon{2}-{3}'.format(south_latitude, north_latitude, west_longitude, east_longitude)
    print(folder_name)
    ...
    fft.draw(target=power, folder=folder_name, longitude=lon,
